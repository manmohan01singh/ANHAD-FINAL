...
const CACHE_VERSION = 'anhad-v13.2.0'; // v13.2.0: Mini player on Home+Favorites+Insights; Guru portrait auto-slide every 5s; Gurbani pankti shuffles on each Home visit; fixed first-nav CSS flash (800ms wait + insights.css pre-warm); dark mode pankti size fixed; Guru slider auto-stops on page leave (low-RAM safe).
