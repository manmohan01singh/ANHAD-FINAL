...
const CACHE_VERSION = 'anhad-v13.3.0'; // v13.3.0: Nitnem Tracker backup export via Web Share/Data URI + clipboard restore; Dynamic night mode 100% equal to pure dark mode; Dynamic authentic Gurbani pankti for all 11 Gurus in carousel; Guru Tegh Bahadur portrait centered crop; Upcoming Gurpurab card text overlap fix on mobile/Android.
