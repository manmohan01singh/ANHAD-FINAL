...
const CACHE_VERSION = 'anhad-v13.5.0'; // v13.5.0: Native Android AudioService command echo loop permanently eliminated: separated JS state sync from user notification controls in AudioForegroundService and AudioServicePlugin.
