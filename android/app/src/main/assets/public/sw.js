...
const CACHE_VERSION = 'anhad-v13.4.0'; // v13.4.0: Deep fix for Gurbani Radio / Simran 1-second audio splash and loop: pre-applied initial seek before playback start, set connectionState to connected on play, and constrained network watchdog to only trigger during genuine connection drops with 20s cooldown.
