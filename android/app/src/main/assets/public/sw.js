...
const CACHE_VERSION = 'anhad-v12.3.0'; // v12.3.0: Clean Apple iOS-grade aesthetic overhaul for The Journey page with zero pink header & borderless squircle icon.
