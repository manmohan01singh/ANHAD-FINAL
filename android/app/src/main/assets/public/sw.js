...
const CACHE_VERSION = 'anhad-v13.8.0'; // v13.7.0: Dynamic night mode identical to dark mode, Guru Teg Bahadur image crop framing fix, single-click theme toggle, and smooth non-shell back button navigation.
