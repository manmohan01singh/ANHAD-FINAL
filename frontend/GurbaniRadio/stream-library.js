    ...
    categories.forEach(function (cat) {
      ...
      streams.forEach(function (s) {
        ...
        card.innerHTML = [
          ...
          '  <div class="sl-card-emoji" style="display:flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:12px;background:linear-gradient(135deg,#C8842A,#E8A83A);flex-shrink:0;' + (isOffline ? 'opacity:0.45;' : '') + '"><img src="../assets/khanda-gold.png" onerror="this.style.display=\'none\'" style="width:26px;height:26px;object-fit:contain;"></div>',
  ...
  function openReplacePopup(streamId) {
    ...
    if (slots.includes(streamId)) {
      ...
      slots.forEach(function (slotId, idx) {
        ...
        btn.innerHTML = '<img src="../assets/khanda-gold.png" onerror="this.style.display=\'none\'" style="width:20px;height:20px;object-fit:contain;margin-right:8px;">' +
