...
const CACHE_VERSION = 'anhad-v10.45.0'; // v10.45.0: Fixed Dark mode relative Guru images, added claymorphism active nav bar highlight for Light & Dark modes, restored Sangat AI intelligence, and purged stale cache.
