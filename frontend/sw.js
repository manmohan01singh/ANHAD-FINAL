...
const CACHE_VERSION = 'anhad-v10.41.0'; // v10.41.0: Fixed Gurpurab event card image rendering, fixed dark mode SVG header theme icon, expanded majestic hero artwork size, and updated SW cache.
