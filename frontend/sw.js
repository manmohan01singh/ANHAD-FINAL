...
const CACHE_VERSION = 'anhad-v11.1.0'; // v11.1.0: Proper dark mode circular 3D guru carousel, wide hero banner in light/dynamic day, and proportional Gurpurab calendar card.
