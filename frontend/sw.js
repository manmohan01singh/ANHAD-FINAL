...
const CACHE_VERSION = 'anhad-v10.85.0'; // v10.85.0: Restored grand 140% mobile hero artwork scale without mask or borders, kept desktop rules isolated to desktop-responsive.css.
