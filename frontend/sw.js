...
const CACHE_VERSION = 'anhad-v11.3.0'; // v11.3.0: Absolute priority master CSS overrides for Gurpurab redesign (86px gold avatar, royal gold CTA button) and cream white cards across all stylesheets.
