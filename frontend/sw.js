...
const CACHE_VERSION = 'anhad-v10.44.0'; // v10.44.0: Fixed Nitnem Tracker full-width bottom nav, integrated Dark Mode Guru portraits carousel with Gurbani Pankti wisdom section, enhanced Sangat AI resilience, and purged stale cache.
