...
const CACHE_VERSION = 'anhad-v13.6.0'; // v13.6.0: Deep fix for Android WebView audio 1s auto-pause: removed conflicting AudioManager focus request from AudioForegroundService, removed duplicate receiver from MainActivity, and protected seeked state in singleton.
