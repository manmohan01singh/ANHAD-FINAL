...
const CACHE_VERSION = 'anhad-v10.38.0'; // v10.38.0: Final polish pass: Removed duplicate circular Guru slider, enlarged main devotional hero artwork with 4-sided soft background dissolve, synchronized sacred Gurbani text, and verified SVG navigation across all themes.
