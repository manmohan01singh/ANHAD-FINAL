...
const CACHE_VERSION = 'anhad-v10.81.0'; // v10.81.0: Desktop precision layout pass - unified 1100px grid, unclipped hero banner, centered progress tracker, balanced sidebar footer buttons.
