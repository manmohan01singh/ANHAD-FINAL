...
const CACHE_VERSION = 'anhad-v10.48.0'; // v10.48.0: Pristine high-clarity hero artwork, fully readable Gurpurab title, dynamic time-of-day card colors, cushion clay mini-player blur, and cache update.
