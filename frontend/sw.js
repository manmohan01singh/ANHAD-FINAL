...
const CACHE_VERSION = 'anhad-v10.86.0'; // v10.86.0: Moved mobile hero image up to balance top/bottom padding and added soft bottom fade mask to hide peeking Gurmukhi text.
