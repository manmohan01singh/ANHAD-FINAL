...
const CACHE_VERSION = 'anhad-v10.82.0'; // v10.82.0: Desktop centering pass - perfectly centered ANHAD pill logo over Chandoa Sahib, eliminated right-side empty space, and applied soft bottom fade mask to hero artwork.
