...
const CACHE_VERSION = 'anhad-v10.95.0'; // v10.95.0: Restored dark mode Guru carousel 3D arc layout & portraits, removed all legacy purple styles from Sehaj Paath, increased Gurpurab Guru avatar to 104px, and unified normal light mode cards/nitnem bar/event card with plush cream white claymorphism.
