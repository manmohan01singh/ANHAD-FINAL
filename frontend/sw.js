...
const CACHE_VERSION = 'anhad-v11.4.0'; // v11.4.0: Inline indestructible styling for Gurpurab redesign (86px gold avatar, royal gold CTA button) and cream white cards across home.
