...
const CACHE_VERSION = 'anhad-v10.47.0'; // v10.47.0: Slim compact horizontal Gurpurab card, sky-blue cushion claymorphism for practice & quick access cards, borderless nav bar highlight, and purged stale cache.
