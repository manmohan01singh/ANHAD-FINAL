...
const CACHE_VERSION = 'anhad-v10.43.0'; // v10.43.0: Fixed Sampuranta Diwas Today Gurpurab event card display, enlarged hero devotional artwork to cinematic scale, refined bottom nav active tab gold styling, removed Sadhsangat nav shadow, and updated SW cache.
