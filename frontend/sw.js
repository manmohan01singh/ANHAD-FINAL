...
const CACHE_VERSION = 'anhad-v10.42.0'; // v10.42.0: Restored Gurpurab card data/image static defaults, fixed nav bar active tab gold highlight, enlarged hero artwork to full cinematic width, and purged stale cache.
