...
const CACHE_VERSION = 'anhad-v10.84.0'; // v10.84.0: Fully preserved SRI GURU GRANTH SAHIB JI hero title with bottom fade mask, balanced sidebar footer to 2 equal buttons, and refined desktop alignment.
