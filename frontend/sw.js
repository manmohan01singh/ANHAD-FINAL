...
const CACHE_VERSION = 'anhad-v10.75.0'; // v10.50.0: Perfected 16px floating gap between mini-player and bottom tab bar, whisper-soft pastel white cushion clay cards, and instant pre-cached navigation.
