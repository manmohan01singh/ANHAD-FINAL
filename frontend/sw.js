...
const CACHE_VERSION = 'anhad-v10.49.0'; // v10.49.0: Soft pastel cushion clay cards in Light mode, pure obsidian dark mode cards, fluid finger swipe Dark Mode Guru carousel, fast SPA pre-caching, and instant cache purge.
