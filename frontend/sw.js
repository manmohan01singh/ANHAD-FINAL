...
const CACHE_VERSION = 'anhad-v10.88.0'; // v10.88.0: Reconstructed Gurpurab calendar card (larger 88px avatar, removed harsh rings, balanced button & badges), added complete dynamic time-of-day cushion claymorphism to all cards (Evening Sunset Orange, Morning Amritvela Purple, Day Sky Blue, Night Obsidian), and tightened bottom hero artwork fade to 68%-76%.
