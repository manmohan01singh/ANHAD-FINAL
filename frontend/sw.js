...
const CACHE_VERSION = 'anhad-v11.8.0'; // v11.8.0: Fixed dark mode card backgrounds (deep obsidian), enhanced Gurpurab card UI, and eliminated dynamic theme scroll lag.
