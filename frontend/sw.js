...
const CACHE_VERSION = 'anhad-v10.46.0'; // v10.46.0: Full viewport bleed hero artwork in Light/Dynamic modes, smooth interactive Dark Mode Guru carousel, cushion-like claymorphism active nav tab without borders, elevated Gurpurab card UI, and guaranteed Sangat AI.
