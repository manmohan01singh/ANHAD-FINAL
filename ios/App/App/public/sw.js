...
const CACHE_VERSION = 'anhad-v11.2.0'; // v11.2.0: Complete redesign of Gurpurab calendar card (86px gold-rimmed avatar, royal gold CTA button, rich hierarchy) and total elimination of unwanted light-blue tints in static light mode.
