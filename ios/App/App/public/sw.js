...
const CACHE_VERSION = 'anhad-v11.6.0'; // v11.6.0: Root-caused delayed 3s blue card flip — removed async light-blue rules in ios-override.css and locked static light mode.
